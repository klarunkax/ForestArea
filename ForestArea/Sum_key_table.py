...
sum_UNECE_EU25 = pandas.read_csv('sum_UNECE_EU25.csv')
change_UNECE_EU25 = pandas.read_csv('change_UNECE_EU25.csv')

sum_key_table = pandas.concat([sum_CLC_EU27, sum_COP_EU27, sum_ESA_EU27, sum_MODIS_EU27, sum_UNECE_EU25], axis=1)
sum_key_table.to_csv('C:/Users/Klara/Documents/Prace/JRC/Teleworking/2022/Forest area EU/Data/sum_tables/sum_key_table.csv')
change_key_table = pandas.concat([change_CLC_EU27, change_COP_EU27, change_ESA_EU27, change_MODIS_EU27, change_UNECE_EU25], axis=1)
