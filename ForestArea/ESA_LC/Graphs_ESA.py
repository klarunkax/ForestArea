...
ESA_1995 = ESA_Forest.loc[:,ESA_Forest.columns.str.startswith('1995')]
total_ESA_Forest['1995'] = ESA_1995.sum(axis=1)
...
total_ESA_Forest = total_ESA_Forest[['GRID_CODE', 'EEA39', 'EU27', '1992', '1995', '2000', '2005', '2006', '2010', '2012', '2015', '2018', '2020']]


#delete the country if it has NA for any of the years
total_ESA_Forest_EEA39 = total_ESA_Forest.dropna(axis=0, how='any', subset=['1992', '1995', '2000', '2005', '2006', '2010', '2012', '2015', '2018', '2020'])
...
total_ESA_Forest_EU27 = total_ESA_Forest.dropna(axis=0, how='any', subset=['1992', '1995', '2000', '2005', '2006', '2010', '2012', '2015', '2018', '2020'])
...
#print(ESA_1992)
ESA_1995 = core_ESA_Forest.loc[:,core_ESA_Forest.columns.str.startswith('1995')]
total_core_ESA['1995'] = ESA_1995.sum(axis=1)
...
# #delete forest categories and keep only totals for each year
total_core_ESA = total_core_ESA[['GRID_CODE', 'EEA39', 'EU27', '1992', '1995', '2000', '2005', '2006', '2010', '2012','2015', '2018', '2020']]
#print(total_core_ESA.to_string())
# # A)create CORE forest for EEA39
total_core_ESA_EEA39 = total_core_ESA.dropna(axis=0, how='any', subset=['1992', '1995', '2000', '2005', '2006', '2010', '2012','2015', '2018', '2020'])
...
total_core_ESA_EU27 = total_core_ESA.dropna(axis=0, how='any', subset=['1992',  '1995', '2000', '2005', '2006', '2010', '2012', '2015', '2018', '2020'])
...
NONcore_ESA_Forest = ESA_Forest[['GRID_CODE', 'EEA39', 'EU27', '1992_100', '1992_110', '1995_100', '1995_110', '2000_100', '2000_110', '2005_100', '2005_110', '2006_100', '2006_110', '2010_100', '2010_110', '2012_100', '2012_110', '2015_100', '2015_110', '2018_100', '2018_110', '2020_100', '2020_110']]

ESA_1992 = NONcore_ESA_Forest.loc[:,NONcore_ESA_Forest.columns.str.startswith('1992')]
total_NONcore_ESA['1992'] = ESA_1992.sum(axis=1)
ESA_1995 = NONcore_ESA_Forest.loc[:,NONcore_ESA_Forest.columns.str.startswith('1995')]
total_NONcore_ESA['1995'] = ESA_1995.sum(axis=1)
...
total_NONcore_ESA['2020'] = ESA_2020.sum(axis=1)

#delete forest categories and keep only totals for each year
total_NONcore_ESA = total_NONcore_ESA[['GRID_CODE', 'EEA39', 'EU27', '1992', '1995', '2000', '2005', '2006', '2010', '2012','2015' , '2018', '2020']]
#print(total_NONcore_ESA.to_string())

# A)create NON-CORE forest for EEA39
total_NONcore_ESA_EEA39 = total_NONcore_ESA.dropna(axis=0, how='any', subset=['1992', '1995','2000', '2005', '2006', '2010', '2012', '2015', '2018', '2020'])
...
total_NONcore_ESA_EU27 = total_NONcore_ESA.dropna(axis=0, how='any', subset=['1992', '1995','2000', '2005', '2006', '2010', '2012', '2018', '2020'])
...
ESA__change_EU27_t["1992-1995"] = ESA__change_EU27_t["1995"] - ESA__change_EU27_t["1992"]
ESA__change_EU27_t["1995-2000"] = ESA__change_EU27_t["2000"] - ESA__change_EU27_t["1995"]
...
ESA__change_EU27_t = ESA__change_EU27_t[['1992-1995', '1995-2000', '2000-2005', '2005-2010', '2010-2015', '2015-2020']]
