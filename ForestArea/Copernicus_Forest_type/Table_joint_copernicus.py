...
import os
import csv
os.chdir('C:/Users/Klara/Documents/Prace/JRC/Teleworking/2022/Forest area EU/Data/CopernicusFT/output/')
table_dbfs = [f for f in os.listdir('C:/Users/Klara/Documents/Prace/JRC/Teleworking/2022/Forest area EU/Data/CopernicusFT/output') if f.endswith('.dbf') and not(f.endswith(".tif.vat.dbf"))]
...
for table_dbf in table_dbfs:
    ...
    table_df = table_df.rename(columns={'SUM': table_name[7:]})  # rename a column SUM  for first 7 letters from the table name
...
# #EXPORT CSV
CLC_Forest.to_csv('C:/Users/Klara/Documents/Prace/JRC/Teleworking/2022/Forest area EU/Data/CopernicusFT/output/COP_Forest.csv')